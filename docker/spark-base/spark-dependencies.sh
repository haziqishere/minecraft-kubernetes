...
echo "Starting Spark dependencies setup for Spark 3.5.1..."

# ===== AWS SDK v1 for Spark 3.5.1 / Hadoop 3.3.4 =====
echo "Setting up AWS SDK v1..."

mkdir -p /usr/share/aws/aws-java-sdk /usr/share/aws/hadoop

# AWS SDK v1 Bundle (required for Hadoop 3.3.4)
...
# Hadoop AWS for Hadoop 3.3.4 (matches Spark 3.5.1)
...
# Download Kafka connector JAR for Spark 3.5.1 (Scala 2.12) and its dependencies
curl -L https://repo1.maven.org/maven2/org/apache/spark/spark-sql-kafka-0-10_2.12/3.5.1/spark-sql-kafka-0-10_2.12-3.5.1.jar -o /usr/share/kafka/spark-sql-kafka-0-10.jar
curl -L https://repo1.maven.org/maven2/org/apache/spark/spark-token-provider-kafka-0-10_2.12/3.5.1/spark-token-provider-kafka-0-10_2.12-3.5.1.jar -o /usr/share/kafka/spark-token-provider-kafka-0-10.jar
